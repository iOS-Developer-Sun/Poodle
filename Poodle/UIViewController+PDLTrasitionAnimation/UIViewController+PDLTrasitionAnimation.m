//
//  UIViewController+PDLTrasitionAnimation.m
//  Poodle
//
...
@interface PDLUIViewControllerTrasitionAnimationDelegate : NSObject <UIViewControllerTransitioningDelegate, UIViewControllerAnimatedTransitioning, UIViewControllerInteractiveTransitioning>
...
@implementation PDLUIViewControllerTrasitionAnimationDelegate
...
@implementation UIViewController (PDLTrasitionAnimation)
...
- (void)pdl_presentViewController:(UIViewController *)viewControllerToPresent duration:(NSTimeInterval)duration animations:(void (^)(id <UIViewControllerContextTransitioning> transitionContext))animations completion:(void (^)(void))completion interactiveTransition:(UIPercentDrivenInteractiveTransition **)interactiveTransition {
    PDLUIViewControllerTrasitionAnimationDelegate *delegate = [[PDLUIViewControllerTrasitionAnimationDelegate alloc] init];
...
@interface PDLUINavigationControllerTrasitionAnimationDelegate : PDLUIViewControllerTrasitionAnimationDelegate <UINavigationControllerDelegate>
...
@implementation PDLUINavigationControllerTrasitionAnimationDelegate
...
@implementation UINavigationController (PDLTrasitionAnimation)
...
@implementation PDLUITabBarControllerTrasitionAnimationDelegate
...
@implementation UITabBarController (PDLTrasitionAnimation)
...
- (void)pdl_setSelectedIndex:(NSUInteger)selectedIndex duration:(NSTimeInterval)duration animations:(void (^)(id <UIViewControllerContextTransitioning> transitionContext))animations interactiveTransition:(UIPercentDrivenInteractiveTransition **)interactiveTransition {
    PDLUITabBarControllerTrasitionAnimationDelegate *delegate = [[PDLUITabBarControllerTrasitionAnimationDelegate alloc] init];
    delegate.transitionDuration = duration;
    delegate.animation = ^(id <UIViewControllerContextTransitioning> transitionContext) {
        if (animations) {
            animations(transitionContext);
