...
// Poodle 2
@class PDLPuddingEngine;
@compatibility_alias JPEngine PDLPuddingEngine;
@class PDLPuddingExtension;
@compatibility_alias JPExtension PDLPuddingExtension;
@class PDLPuddingFolding;
@compatibility_alias JPBoxing PDLPuddingFolding;

// Poodle 9

#define PDLPudding_JPExtensionEnabled 0
